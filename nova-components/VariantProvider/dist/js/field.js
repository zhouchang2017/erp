...
Nova.booting(function (Vue, router) {
    Vue.component('index-variant-provider', __webpack_require__(3));
    Vue.component('detail-variant-provider', __webpack_require__(6));
    Vue.component('form-variant-provider', __webpack_require__(9));
});
