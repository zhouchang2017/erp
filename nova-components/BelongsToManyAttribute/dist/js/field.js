...
Nova.booting(function (Vue, router) {
  ...
  Vue.component('index-belongs-to-many-attribute', __webpack_require__(3));
  Vue.component('detail-belongs-to-many-attribute', __webpack_require__(6));
  Vue.component('form-belongs-to-many-attribute', __webpack_require__(9));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TranslationFormField__ = __webpack_require__(22);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    setInitialValue: function setInitialValue() {
      ...
      this.attributes = this.field.attributes.map(function (attribute) {
        // const isChecked = this.value.find(related => related.id === attribute.id)
        var isChecked = _.get(_this.value, attribute.id, null);
        var value = Object.keys(_this.field.locales).reduce(function (res, locale) {
          res[locale] = _.get(isChecked, locale + '.text_value', null);
          return res;
        }, {});
        var _field = _this.field,
            locales = _field.locales,
            indexLocale = _field.indexLocale,
            singleLine = _field.singleLine;
        ...
        return {
          ...
          'value': value,
          'checked': !!isChecked,
          locales: locales, indexLocale: indexLocale, singleLine: singleLine
        };
      });
    },
    ...
    toggle: function toggle(attribute) {
  ...
  computed: {
    checkedAttribute: function checkedAttribute() {
...
var render = function() {
  ...
  return _c(
    ...
    [
                ...
                return _c(
                  ...
                  [
                    ...
                    _c("label", {
                      ...
                      domProps: { textContent: _vm._s(attribute.name) },
                      on: {
      ...
      _vm._v(" "),
      _vm._l(_vm.checkedAttribute, function(attribute) {
