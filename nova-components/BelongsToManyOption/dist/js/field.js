...
Nova.booting(function (Vue, router) {
    Vue.component('index-belongs-to-many-option', __webpack_require__(3));
    Vue.component('detail-belongs-to-many-option', __webpack_require__(6));
    Vue.component('form-belongs-to-many-option', __webpack_require__(9));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__SkuTable__ = __webpack_require__(22);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: { SkuTable: __WEBPACK_IMPORTED_MODULE_1__SkuTable___default.a },
  ...
  methods: {
    ...
    toggle: function toggle(value) {
      if (this.isChecked(value)) {
        var index = this.checked.findIndex(function (item) {
          return item === value;
        });
    ...
    isChecked: function isChecked(value) {
      return !!this.checked.find(function (optionValue) {
    ...
    setSkuTableSchema: function setSkuTableSchema() {
      ...
      var formData = Object.values(_.groupBy(this.checked, 'option_id'));
      if (formData.length <= 0) {
        this.skuTableSchema = [];
        return;
      }
      this.skuTableSchema = this.genCartesian(formData).map(function (item) {
        var key = item.map(function (attr) {
          return attr.id;
        }).join('-');
        var cache = _this.getSkuItemAttr(key);
        if (!cache) {
          cache = { sku: '', price: 0 };
          _this.setSkuItemAttr({ key: key, attr: cache });
        }
  ...
  computed: {
    selectedOptions: function selectedOptions() {
      ...
      return Array.from(new Set(this.checked.map(function (option) {
        return option.option_id;
      }))).map(function (option_id) {
        var _options$find = _this2.options.find(function (item) {
          return item.id === option_id;
        }),
            id = _options$find.id,
            code = _options$find.code,
            name = _options$find.name;
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._l(_vm.options, function(option) {
        return _c(
          "default-field",
          {
            ...
            attrs: { field: option, errors: _vm.errors, fullWidthContent: true }
          },
          [
            _c("template", { slot: "field" }, [
              _c(
                "ul",
                { staticClass: "list-reset ul-container" },
                _vm._l(option.values, function(value) {
                  return _c(
                    "li",
                    { key: value.id, staticClass: "flex items-center w-1/3" },
                    [
                      _c("checkbox", {
      ...
      _vm._v(" "),
      _c("sku-table", {
        attrs: { selectedOptions: _vm.selectedOptions },
        model: {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(13)("ceeaf8d6", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: {
    ...
    selectedOptions: { type: Array, default: function _default() {
        return [];
      } }
  },
    ...
    headers: function headers() {
      ...
      if (col) {
        return [].concat(_toConsumableArray(col.options.map(function (item) {
          return {
            text: _this.selectedOptions.find(function (option) {
              return option.id === item.option_id;
            }).name,
            value: 'value_name'
          };
        })), [{ text: 'Code', value: 'code' }, { text: '价格', value: 'price' }]);
      }
      return [];
    }
  }
        ...
        [
          _c(
            ...
            _vm._l(_vm.headers, function(header) {
              return _c("th", { key: header.text, staticClass: "text-left" }, [
